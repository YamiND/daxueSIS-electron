              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="create-assignment-form" class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Class to create Assignment for</label>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">
                          <button type="button" class="btn btn-success" name="classSelect" id="classSelect">Next</button>
                        </div>
                      </div>
                    </form>

                    <form method="post" id="create-assignment-form-2" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">
                          ...
                          <button type="submit" class="btn btn-success" name="edit" value="edit">Create Assignment</button>
                        </div>
                      </div>
                    </form>
                  </div>
    ...
    <script>
      $(document).ready(function() {  
        ...
        $("#classSelect").click(function(){
          ...
          $("#create-assignment-form").hide();
          $("#create-assignment-form-2").show();
        
        }); 

        // submit form using $.ajax() method
        $('#create-assignment-form-2').submit(function(e){
          e.preventDefault(); // Prevent Default Submission
          
          $.ajax({
            url: '/includes/assignments/createAssignment.php',
            type: 'POST',
          ...
          .done(function(data){
              ...
              $("#create-assignment-form-2").hide();
              $("#create-assignment-form-2")[0].reset();
              // On load have our classes populate
              loadTeacherClasses();
              $('#classID').val([]).trigger('change');
              $("#create-assignment-form").show();
          })
          .fail(function(){
